module github.com/Vivino/go-loggers-mapper-revel

go 1.20

replace github.com/revel/revel => github.com/Vivino/revel v0.11.2-0.20211006090011-d9d6d0f92909

require (
	github.com/Vivino/go-loggers v1.1.1-0.20230830093419-3180fd46e949
